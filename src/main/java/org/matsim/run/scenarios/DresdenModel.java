...
//		the tarifzone shp file basically is a dresden shp file with fare prices as additional information
		simWrapper.defaultParams().setShp(String.format("/net/ils/roeder/agimo-digital-twin/cache/matsim-dresden/input/v1.0/vvo_tarifzone_10_dresden/%s_vvo_tarifzone_10_dresden_utm32n.shp", VERSION));
...
//		fare prices for vvo tarifzone 10 aka Dresden have to be set in shp file.
		...
		vvo10.setOrder(1);
		vvo10.setFareZoneShp(String.format("/net/ils/roeder/agimo-digital-twin/cache/matsim-dresden/input/v1.0/vvo_tarifzone_10_dresden/%s_vvo_tarifzone_10_dresden_utm32n.shp", VERSION));
